...
package dif is
   ...
   package DIF_Vectors is new Ada.Containers.Vectors (Index_Type => Natural, 
   ...
   procedure createNamedDIF
     (ID : Integer; vector : in out DIF_Vector; name : Unbounded_String);
   ...
   procedure disconnectIPCP
     (name : Unbounded_String; self : in out DIF_Access);
