      ...
      loop
         ...
         or 
            ...
            if RIB.Find_Entry(RIB_E.Name) then
               ...
               for i in RIB_E.Obj_Type.Connected_DIFs.First_Index .. RIB_E.Obj_Type.Connected_DIFs.Last_Index loop
                  RIB.Add_DIF (RIB_E.Name, RIB_E.Obj_Type.Connected_DIFs(i));
               end loop;
